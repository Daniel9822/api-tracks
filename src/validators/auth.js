...
const registerValidator = [
    ...
    check('age', 'age property is required').exists().notEmpty().isInt().isNumeric(),
    check("email", 'email property is required and have email format').exists().notEmpty().isEmail(),
